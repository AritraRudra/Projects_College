...
public class CompressedBlockInputStream extends FilterInputStream {
    ...
    private void readAndDecompress() throws IOException {
    	...
    	/*int sizeCompressed=in.read();
    	System.out.println("Sizecomp in zip Input->get_Decompres "+sizeCompressed);
    	inLength=sizeCompressed;
    	int sizeDeCompressed=in.read();
    	System.out.println("Sizedecomp  in zip Input->get_Decompres "+sizeDeCompressed);
    	outLength=sizeDeCompressed;*/
