...
public class CompressedBlockOutputStream extends FilterOutputStream {
    ...
    public void compressAndSend() throws IOException { //changed from protected to public
        if (len > 0) {
            ...
            //System.out.println("Length in zip Out->compres_send "+len);
            //out.write(len);
            //System.out.println("Size in zip Out->compres_send "+size);
            //out.write(size);
            //System.out.println("writing in zip Out->compres_send ");
